...
<div id="content">   
 <!-- <?php echo $prev; ?>-->
  ...
  <h3>S K P D<input id="Xskpd" name="Xskpd" style="width: 100px;border: 0;" />
  	<input id="nm_skpd" name="nm_skpd" readonly="true" style="width:600px;border: 0;"/> </h3>
 
  <h3>SUB <input id="giat" name="giat" style="width: 150px;" />
  	<input id="nm_giat" name="nm_giat" readonly="true" style="width:650px;border: 0;"/> </h3>
